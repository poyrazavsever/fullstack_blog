...
const UserModal = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-neutral-950 bg-opacity-80">
      <motion.div
        className="border bg-white border-neutral-200 dark:bg-neutral-950 dark:border-neutral-800 bg-opacity-10 dark:bg-opacity-10 rounded-lg shadow-lg p-8 max-w-md w-full backdrop-blur-md"
        initial={{ opacity: 0, scale: 0.8 }} // Açılma animasyonu
        animate={{ opacity: 1, scale: 1 }} // Bitiş animasyonu
        exit={{ opacity: 0, scale: 0.8 }} // Kapanma animasyonu
