...
const LargeCard = () => {
  return (
    <a href='/blog/1' className="relative p-4 rounded-lg border bg-neutral-200 border-neutral-300 dark:bg-neutral-800 dark:border-neutral-700 bg-opacity-10 backdrop-blur-lg shadow-lg -z-10">
      {/* Resim */}
